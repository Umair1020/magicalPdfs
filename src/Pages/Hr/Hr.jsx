...
const Hrservices1 = () => {
  ...
  const handleUrl = async () => {
    try {
      ...
      // Set ingestLoading to true after setting the state variables
  ...
  const chatAll = {
    ...
    background: "#464FEB", // Commented out as per your original CSS
    fontFamily: "var(--sans)",
    fontWeight: 500,
    fontStyle: "normal",
    // marginLeft: "10px",
  ...
  return (
    <>
      <Desktop>
        ...
        <div className={`max-w-[] col-lg-11 mx-auto p-2 hr`}>
          <div className="text-left  my-4">
            <h1 className="hrHead " style={{ paddingLeft: "56px" }}>
              Top Candidates Needed: Immediate Hire
            </h1>
          </div>
          ...
          <div className="row d-flex justify-between">
            <div className="col-lg-5 " style={{ paddingLeft: "70px" }}>
              <h3>Upload CV</h3>
              <br />
            ...
            <div className="col-lg-5 " style={{ margin: "inherit" }}>
          ...
          <>
            <button
              className="p-4 d-flex chatAll mx-auto"
              onClick={handleUrl}
              // disabled={isUploadButtonDisabled}
            >
              {loading1 ? (
      ...
      <Mobile>
        ...
        <div className="row">
          ...
          <div className={`w-75  mx-auto p-2 hr`}>
            <div className="  my-4">
              <h1 className="hrHead  ">
                Top Candidates Needed: Immediate Hire
              </h1>
